...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xiaowu0125/PrivateDemo"
  ...
  s.source       = { :git => "https://github.com/xiaowu0125/PrivateDemo.git", :tag => s.version.to_s }
  ...
  s.source_files  = "PrivateDemo/Category/**/*.{h,m}"
